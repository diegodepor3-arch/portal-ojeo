...
const FEATURES = [
  {
    icon: "⚡",
    title: "Tiempo real",
    desc: "Sincronización automática con Google Sheets. Cualquier cambio aparece al instante.",
  },
  {
    icon: "📊",
    title: "Radares y estadísticas",
    desc: "Visualiza las habilidades de cada jugador con gráficos radar interactivos.",
  },
  {
    icon: "🔍",
    title: "Búsqueda avanzada",
    desc: "Filtra por posición, edad, país, nota y más para encontrar al jugador perfecto.",
  },
  {
    icon: "📄",
    title: "Informes en PDF",
    desc: "Genera fichas profesionales listas para enviar al director deportivo.",
  },
  {
    icon: "⚖️",
    title: "Comparador",
    desc: "Compara 2 o 3 jugadores lado a lado para tomar la mejor decisión.",
  },
  {
    icon: "🏟️",
    title: "Cantera",
    desc: "Sección dedicada al scouting de jugadores Sub-12 a Sub-18.",
  },
];
    ...
    <div style={{
      ...
      <section id="features" style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          <h2 style={{ fontSize: 40, fontWeight: 900, color: "#fff", letterSpacing: "-1px", margin: 0 }}>
            Todo lo que necesitas
          </h2>
          <p style={{ color: "#6b7280", fontSize: 16, marginTop: 12 }}>
            Herramientas profesionales para ojeadores modernos
          </p>
        </div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{ color: "#9ca3af", fontSize: 16, marginBottom: 32 }}>
            Tu base de jugadores te está esperando
          </p>
          <a href="/jugadores" style={{
            background: "linear-gradient(135deg, #3b82f6, #2563eb)",
            color: "#fff",
