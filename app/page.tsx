  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080c14", color: "#e5e7eb", fontFamily: "'Segoe UI', system-ui, sans-serif", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 200, padding: "0 40px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", background: scrolled ? "rgba(8,12,20,0.95)" : "transparent", backdropFilter: scrolled ? "blur(12px)" : "none", borderBottom: scrolled ? "1px solid #1f2937" : "none", transition: "all 0.3s" }}>
        ...
        <a href="/login" style={{ background: "linear-gradient(135deg, #3b82f6, #2563eb)", color: "#fff", borderRadius: 8, padding: "9px 22px", fontSize: 14, fontWeight: 700, textDecoration: "none", boxShadow: "0 4px 15px rgba(59,130,246,0.4)" }}>
          Entrar →
        </a>
      </nav>
      ...
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "120px 24px 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "center" }}>
          <a href="/login" style={{ background: "linear-gradient(135deg, #3b82f6, #2563eb)", color: "#fff", borderRadius: 10, padding: "14px 32px", fontSize: 16, fontWeight: 700, textDecoration: "none", boxShadow: "0 8px 25px rgba(59,130,246,0.4)" }}>
            Entrar al portal →
          </a>
          <a href="/registro" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid #374151", color: "#d1d5db", borderRadius: 10, padding: "14px 32px", fontSize: 16, fontWeight: 600, textDecoration: "none" }}>
            Crear cuenta
          </a>
        </div>
      ...
      <section style={{ padding: "80px 24px", textAlign: "center" }}>
        <div style={{ background: "linear-gradient(135deg, #1a1f2e, #111827)", border: "1px solid #1f2937", borderRadius: 20, padding: "60px 40px", maxWidth: 700, margin: "0 auto", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="/login" style={{ background: "linear-gradient(135deg, #3b82f6, #2563eb)", color: "#fff", borderRadius: 10, padding: "14px 36px", fontSize: 16, fontWeight: 700, textDecoration: "none", boxShadow: "0 8px 25px rgba(59,130,246,0.4)", display: "inline-block" }}>
              Iniciar sesión →
            </a>
            <a href="/registro" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid #374151", color: "#d1d5db", borderRadius: 10, padding: "14px 36px", fontSize: 16, fontWeight: 700, textDecoration: "none", display: "inline-block" }}>
              Crear cuenta
            </a>
          </div>
        </div>
